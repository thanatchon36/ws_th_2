...
function loadBlogPostData(draw, top){
    ...
    d3.tsv(fileName, function(error, rawData) {
        ...
        rawData = rawData.filter(function(d){
            ...
            //     startDate = inputFormat.parse('2011-01-01T00:00:00');
            //     endDate = inputFormat.parse('2014-01-01T00:00:00');
            // }
...
function loadAuthorData(draw, top){
    ...
    d3.tsv(fileName, function(error, rawData) {
        ...
        else if(fileName.indexOf("lda")>=0){
            startYear = 2011;
            endYear = 2022;
        }
        else if(fileName.indexOf("meeting_1")>=0){
            startYear = 1941;
            endYear = 1963;
        }
        else if(fileName.indexOf("meeting_2")>=0){
            startYear = 1963;
            endYear = 1985;
        }
        else if(fileName.indexOf("meeting_3")>=0){
            startYear = 1985;
            endYear = 2008;
        }
